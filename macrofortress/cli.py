...
import click
import cv2
from macrofortress.constants.help import GREYSCALE_HELP_MESSAGE

from macrofortress.constants.logging import LOG_FORMAT
from macrofortress.constants.macro import (
    CURSOR_DOWN,
    CURSOR_LEFT,
    CURSOR_RIGHT,
    CURSOR_UP,
